...
```{r dataset-download, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
BM is a model that can be easily simulated. Its most important parameter is $\sigma$.
